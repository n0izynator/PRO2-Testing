...
namespace XUnitTestProject1.Controllers
{
    public class UsersInitTests
    {
        ...
        public async Task PostUsers_200Ok()
        {
            ...
            var postResponse = await _client.PostAsync($"{_client.BaseAddress.AbsoluteUri}api/users", new StringContent(JsonConvert.SerializeObject(newUser), Encoding.UTF8, "application/json"));
